  ...
  return (
    <div className="p-4 mx-auto max-w-[1400px]">
      ...
      {contacts.length === 0 ? (
        ...
        <>
          <div className="mb-4 flex flex-col md:flex-row justify-between item-center gap-4">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex justify-center space-x-2">
                        <button
                          ...
                          className="px-3 py-1.5 bg-blue-500 text-white rounded hover:bg-blue-600 writing-normal"
                        >
                          수정
                        </button>
                        <button 
                        onClick={()=>handleDelete(contact._id)}
                        className="px-3 py-1.5 bg-red-500 text-white rounded hover:bg-red-600 writing-normal">
                          삭제
                        </button>
                      </div>
                    </td>
